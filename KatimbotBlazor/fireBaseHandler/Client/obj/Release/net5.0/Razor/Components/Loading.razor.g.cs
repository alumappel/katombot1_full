#pragma checksum "C:\Users\נטע\Documents\תואר\שנה ג\idk\fireBaseHandler\Client\Components\Loading.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fb31fda87f8c4dc215cbd3c44ff14f91adbe17ac"
// <auto-generated/>
...
#nullable disable
    public partial class Loading : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.AddMarkupContent(0, @"<div class=""loading""><div class=""d-flex justify-content-center mt-2 mb-2""><div class=""lds-default centerObject""><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div></div>");
        }
